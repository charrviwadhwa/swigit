...
const runSilent = (cmd) => execSync(cmd).toString().trim();
export async function superInit(url) {
    ...
    try {
        ...
        console.error(chalk.red('❌ Failed to init.'));
    }
}
...
export async function oneCommandShip(message) {
    try {
...
export async function smartSwitch(name) {
    ...
    try {
        ...
        console.error(chalk.red('❌ Failed to switch branches.'));
    }
}
export async function undoLastCommit() {
    try {
        ...
        console.error(chalk.red('❌ Failed to undo.'));
    }
}
export async function wipeChanges() {
    ...
    try {
        ...
        console.error(chalk.red('❌ Failed to wipe.'));
    }
}
export async function repoInfo() {
    ...
    try {
        ...
        console.error(chalk.red('❌ Could not fetch repo info.'));
    }
}
export async function mergeAndPush(targetBranch) {
...
export async function smartClone(url) {
